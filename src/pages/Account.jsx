    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="duolingo-card mb-6">
        <div className="flex items-center gap-6 mb-6 pb-6 border-b border-gray-200">
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-gholink-blue to-gholink-cyan flex items-center justify-center text-white text-3xl font-bold">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-lg bg-gholink-blue/10 flex items-center justify-center flex-shrink-0">
              <User className="text-gholink-blue" size={20} />
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="duolingo-card text-center">
          <div className="text-3xl font-bold text-gholink-blue mb-1">
            {profile?.points?.toLocaleString() || '0'}
          </div>
          <div className="text-sm text-gray-600">Total Points</div>
        </div>
        <div className="duolingo-card text-center">
          <div className="text-3xl font-bold text-gholink-cyan mb-1">
            {profile?.level || '1'}
          </div>
